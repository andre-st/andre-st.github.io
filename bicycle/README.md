...
- dünnes Stahlseil zwischen Sattel- und Sitzstreben
...
- zeitlang fuhr ich nur mit dem Hiplock Z-Lok herum, 
	keine Lust/Sinn 2-kg-Schloss herumzufahren; 
...
Mit "Rentner-Reflektoren" verliert man beim Sport-Rad Street-Credibility.
StVoZ-ungültige, aber funktionale, ästhetischere Alternativen:
...
- Bürsten von PEATY'S
- Handtücher und viele Lappen
- Carbon-verträglicher Radreiniger
- Kercher Mobile Outdoor Cleaner OC3 Plus 7l Niederdruckreiniger (geht schnell und bequem, vielleicht aber doch schädlich für Fett/Lager auch wenn Niedrigdruck)
- ...
...
(hab ich damals vom Fahrradladen bekommen, die würden das auch so machen)
...
- Da Aluminium im Steuerrohrbereich durch Feuchtigkeit korrodieren kann, 
	...
	ABER kein Fett auf die Lagersitze, da dort präziser Halt erforderlich ist [widerspricht dem was ich sonst so sehe; meint vielleicht nicht IS?].
...
Mein Fall: Giant-Overdrive-Steerer, konische Carbon-Gabel in Alu-Rahmen, Vorder-Bremskabel im Gabelholm (aber nicht im Steuerrohr) integriert
...
HEADSET:
	ChatGPT:
		Die Lagerdimensionen eines Steuersatzes sind genormt, 
		sodass du Ersatzlager auch von anderen Herstellern verwenden kannst, 
		solange sie die richtigen Spezifikationen haben.
		Das bedeutet, du kannst Ersatzlager von anderen Herstellern wie 
		Cane Creek, FSA, Acros oder Ritchey verwenden, 
		solange sie dieselben Maße haben.
		Manche Hersteller spezifizieren den Winkel der Lagersitze (z. B. 36°/45° oder 45°/45°).
		Stelle sicher, dass dein Ersatzlager den richtigen Winkel hat, um ein optimales Sitzverhalten zu gewährleisten.
	
	
	OVERDRIVE STEERER (Version 1):
		Giant's original oversized fork steerer-tube technology. 
		Designed to provide solid front-end steering performance, 
		the system's oversized headset bearings and tapered steerer tube provide optimal steering stiffness. 
		Road models feature 1 1/8-inch top and 1 1/4-inch bottom bearings, 
		while the mountain version features 1 1/8-inch top and 1 1/2-inch bottom bearings.
		OverDrive provides up to 15 percent more torsional steering stiffness than straight steerer-tube designs. 
		This translates into much more accurate steering input from a rider's hands, 
		through the handlebar and stem, 
		and down to the front wheel. 
		Whether hammering uphill or carving through a corner, 
...
- Compact Dropbar: 
	...
	die Hoods dann übergangslos bzw. mit minimalem Wellental (mit Lenkerband ranhalten) ansetzen und den Händen "anbieten" 
...
- Aeroposition: mehr Speed, unterm Wind wegtauchen
	...
	- je nach Sattel drückt evtl Spitze; gibt Stubby/Short-Nose Saddles (ISM), gibt speziellen Redshift-Seat-Post zum Vor/Rückklappen
...
- Armpads müssen Ellenbogen aufnehmen, nicht nur Unterarme, sonst Belastung Schultern statt Entlastung (Stütze über Skelett)
	...
	- mit Spacer nach oben bringen = evtl. näher an Ellenbogen (Steuerrohr meist zum Fahrer geneigt)
...
- Radästhetik schlechter; Sportrad eigtl. max. minimalistisch und 'Unterlenker vs TT-Bars'?; 
	- bei Gravel baut das Rad dadurch optisch nach rechts-oben auf wie Sprungschanze in Himmel, 
		schöner wäre parallel zum Boden und gleichhoch/unterhalb zum Sattel (eher Rennrad-Geo)
	- Winkel ausrichten am oberrohr falls mgl./noch sinnvoll
	- weiterer Baustein zur Fred-Werdung
- Klemmung mit Montagepaste, einheitliche Gaps bei den Schraubklemmen beachten
	- Schutz der Lenkerstange mit Elektroisolierbar fraglich bzgl. Haltfestigkeit, eher abzuraten
- ich verwende Profile Design T5+ mit dazugehörigem Profile Design Lenkerband; 
	Stangen sehr nah beeinander aber Pads max Außen und zum Körper,
...
(Abb.: Zelt auf dem Camping-Platz lieber etwas ordentlicher aussehen lassen als hier)
...
Zucker gibt zwar kurzfristig Energie, aber schädlich (kleine Kristalle schneiden überall herum) und hängt irgendwann zum Hals raus.
Abwechslung/Alternativen wichtig.
"Echtes" Essen auf Dauer bekömmlicher als Spezialfood.
...
Ökonomische Zusammenhänge, Rationales, ...  TODO
...
- Tour mit langsamerem Partner (meist Freundin/Ehefrau)
	...
	- Beach Cruiser bzw. entspannte Räder mit Latschen und Schlapphut, die nicht zum Pacen motivieren
	- ermöglichen, dass ein Partner hin und wieder in eigenem Tempo vorausfährt und der andere ihn einholt
